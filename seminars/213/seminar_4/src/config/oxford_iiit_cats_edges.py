...
from ..dataset import OxfordIIITPetEdgesDataset
...
class DataConfig:
    ...
    def train_dataset(self) -> Dataset:
        return OxfordIIITPetEdgesDataset(self.data_dir,
                                         resize=(256, 256),
...
class TrainConfig:
    ...
    def run_name(self) -> str:
        return f"oxfordcatsedges_disloss{self.dis_loss_coef}_genlr{self.gen_lr}" \
